...
func (a *ClusterMetricsAPI) DefMetricsInfo(n string) map[string]collector.MetricInfo {
	...
	a.MetricsInfo = map[string]collector.MetricInfo{
		"appsSubmitted":         collector.NewMetric(n, s, "applications_submitted", "Total applications submitted", prometheus.CounterValue, nil),
		"appsCompleted":         collector.NewMetric(n, s, "applications_completed", "Total applications completed", prometheus.CounterValue, nil),
		"appsPending":           collector.NewMetric(n, s, "applications_pending", "Applications pending", prometheus.GaugeValue, nil),
		"appsRunning":           collector.NewMetric(n, s, "applications_running", "Applications running", prometheus.GaugeValue, nil),
		"appsFailed":            collector.NewMetric(n, s, "applications_failed", "Total application failed", prometheus.CounterValue, nil),
		"appsKilled":            collector.NewMetric(n, s, "applications_killed", "Total application killed", prometheus.CounterValue, nil),
		"reservedMB":            collector.NewMetric(n, s, "memory_reserved", "Memory reserved", prometheus.GaugeValue, nil),
		"availableMB":           collector.NewMetric(n, s, "memory_available", "Memory available", prometheus.GaugeValue, nil),
		"allocatedMB":           collector.NewMetric(n, s, "memory_allocated", "Memory allocated", prometheus.GaugeValue, nil),
		"totalMB":               collector.NewMetric(n, s, "memory_total", "Total memory", prometheus.GaugeValue, nil),
		"reservedVirtualCores":  collector.NewMetric(n, s, "virtual_cores_reserved", "Virtual cores reserved", prometheus.GaugeValue, nil),
		"availableVirtualCores": collector.NewMetric(n, s, "virtual_cores_available", "Virtual cores available", prometheus.GaugeValue, nil),
		"allocatedVirtualCores": collector.NewMetric(n, s, "virtual_cores_allocated", "Virtual cores allocated", prometheus.GaugeValue, nil),
		"totalVirtualCores":     collector.NewMetric(n, s, "virtual_cores_total", "Total virtual cores", prometheus.GaugeValue, nil),
		"containersAllocated":   collector.NewMetric(n, s, "containers_allocated", "Containers allocated", prometheus.GaugeValue, nil),
		"containersReserved":    collector.NewMetric(n, s, "containers_reserved", "Containers reserved", prometheus.GaugeValue, nil),
		"containersPending":     collector.NewMetric(n, s, "containers_pending", "Containers pending", prometheus.GaugeValue, nil),
		"totalNodes":            collector.NewMetric(n, s, "nodes_total", "Nodes total", prometheus.GaugeValue, nil),
		"lostNodes":             collector.NewMetric(n, s, "nodes_lost", "Nodes lost", prometheus.GaugeValue, nil),
		"unhealthyNodes":        collector.NewMetric(n, s, "nodes_unhealthy", "Nodes unhealthy", prometheus.GaugeValue, nil),
		"decommissionedNodes":   collector.NewMetric(n, s, "nodes_decommissioned", "Nodes decommissioned", prometheus.GaugeValue, nil),
		"decommissioningNodes":  collector.NewMetric(n, s, "nodes_decommissioning", "Nodes decommissioning", prometheus.GaugeValue, nil),
		"rebootedNodes":         collector.NewMetric(n, s, "nodes_rebooted", "Nodes rebooted", prometheus.GaugeValue, nil),
		"activeNodes":           collector.NewMetric(n, s, "nodes_active", "Nodes active", prometheus.GaugeValue, nil),
	}
